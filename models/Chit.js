...
const chitSchema = new mongoose.Schema({
  ...
  chitType: { type: String, enum: ['auction', 'tallu'], required: true },
  memberCount: { type: Number, required: true },
  chitAmount: { type: Number, required: true },
  installmentAmount: { type: Number, required: true },
  commission: { type: Number, default: 4 },
  chitDate: { type: Number, required: true },     // day of month e.g. 5
  totalMonths: { type: Number, required: true },  // duration
